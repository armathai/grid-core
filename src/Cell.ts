...
export class Cell<T> {
    public static readonly minSize: number = 1 / Number.MAX_SAFE_INTEGER;
     ...
     */
    public constructor(config: ICellConfig) {
    ...
    private _getBounds(rawBounds: IRawBounds | undefined): Rect {
        const b = rawBounds ? rawToRect(rawBounds) : new Rect(0, 0, Cell.minSize, Cell.minSize);
        const o = this.offset;
    ...
    private _buildPadding(padding: Rect): Rect {
